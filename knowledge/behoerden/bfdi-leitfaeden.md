...
### Aufgaben (§ 14 ff. BDSG, Art. 57 DSGVO)

- Untersuchung von Beschwerden
- Kontrolle / Audits bei Verantwortlichen
- Beratung (Behörden, Parlament, Wirtschaft)
- Bußgelder gegen TK-Anbieter, Bundesbehörden, Post
- Zuständigkeit für § 29 TDDDG (Aufsicht über § 25 TDDDG)

### Nicht zuständig (meistens Länderbehörden):

- Privatwirtschaftliche Unternehmen (Aufsicht bei LDI NRW, LfD Bayern, BlnBDI, LfDI BW, HmbBfDI etc.)
- Kirchen (eigene Datenschutzbeauftragte)
- Öffentliche Stellen der Länder

## Wichtige Leitfäden und Publikationen

### Allgemeine Leitfäden

- **„Datenschutz im Arbeitsverhältnis"** — Basiswissen § 26 BDSG
- **„Orientierungshilfe Künstliche Intelligenz und Datenschutz"** (2024)
- **„Infoblatt zu Betroffenenrechten"** (regelmäßig aktualisiert)

### Drittland-Transfer

- **FAQ zum EU-US Data Privacy Framework** (ab 2023, laufend aktualisiert)
- **Kurzmeldung „Angemessenheitsbeschluss zum EU-U.S. DPF in Kraft getreten"** (10.07.2023)

### Meldepflichten

- **Merkblatt „Meldung einer Verletzung des Schutzes personenbezogener Daten"**
- Online-Formular zur Datenpannen-Meldung (für Bundes-zuständige Stellen)

### TK / Digitale Dienste

- **Positionsbestimmungen zu § 25 TDDDG**
- **Stellungnahmen zur EU ePrivacy-Verordnung** (in Diskussion seit 2017)
- **FAQ zu Fernmeldegeheimnis**

### Health / Telematikinfrastruktur (TI)

- **Orientierungshilfen zu ePA (elektronische Patientenakte), E-Rezept, DiGA**
- Relevante Stellungnahmen zu § 291a SGB V

### Bußgeldkatalog der DSK

- BfDI ist Mitherausgeber des **Konzepts der DSK zur Bußgeldzumessung bei Verstößen gegen die DSGVO** (Oktober 2019, laufend ergänzt)
- Berechnungsformel: Jahresumsatz × Schwere-Faktor × Tatmodifikator

## Tätigkeitsberichte

Jährlich erscheinender Tätigkeitsbericht (ca. 200–300 Seiten), frei verfügbar. Enthält:
- Schwerpunkte des Jahres
- Anonymisierte Fallbeispiele
- Statistiken Beschwerden / Bußgelder / Datenpannen
...
- **Bürger-Beschwerden:** Online-Formular, Post, E-Mail
- **Datenpannen-Meldung:** Online-Formular (für Stellen, die BfDI-Zuständigkeit unterliegen)
- **Allgemeine Anfragen:** Hotline, ServiceDesk

## Länder-Aufsichtsbehörden (Gegenstück für Privatwirtschaft)

| Bundesland | Behörde | URL |
|------------|---------|-----|
| Baden-Württemberg | LfDI BW | baden-wuerttemberg.datenschutz.de |
| Bayern | LDA (nicht-öffentlich) / LfD (öffentlich) | lda.bayern.de / datenschutz-bayern.de |
...
| Mecklenburg-Vorpommern | LfDI MV | datenschutz-mv.de |
...
## Welche Behörde ist zuständig? (Faustregel für Tech-Unternehmen)

1. **Öffentliche Bundesstellen / Bundesbehörden / TK-Anbieter:** BfDI
2. **Privatwirtschaftliche Unternehmen:** Länder-Behörde am Sitz der Hauptniederlassung
3. **Bei Niederlassungen in mehreren Ländern:** federführende Behörde nach Art. 56 DSGVO + Kohärenzverfahren
4. **Cross-border-Unternehmen (EU):** „Lead Supervisory Authority" (One-Stop-Shop) — z. B. DPC Ireland für Meta, Google Irland

## Praktischer Umgang

- **Regelmäßig Tätigkeitsberichte lesen** — Frühindikator, was als nächstes geprüft wird
- **FAQ-Sammlungen** vor Beschwerde / Anfrage prüfen
- **Beratungsanfragen möglich** — BfDI berät proaktiv (informell)
- **Anhörungsrecht** vor Bußgeldbescheid — ernst nehmen, DSB + Rechtsabteilung einbeziehen
